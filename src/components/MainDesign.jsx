  ...
  return (
    <div className="w-screen h-screen ">
      <div className=" z-1 absolute flex justify-center">
        <div className="w-[800px] shrink-0 bg-[#F3F4F6] h-screen rounded-l-3xl"></div>
        <div className="w-[800px] shrink-0 bg-[#0F141E] h-screen rounded-r-3xl"></div>
      </div>
      ...
      <div className="absolute z-3 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full border-gray-300 border-1 shrink-0 w-185 h-185"></div>
      ...
      <div className="z-4 top-20 left-45 relative w-44 h-44 rounded-full bg-[#FF8E27]">
        <div
      ...
      <div className="z-4 top-170 left-315 relative w-36 h-36 rounded-full bg-[#6E72C9]">
        <div
          className="absolute inset-0 rounded-full mix-blend-overlay opacity-35"
          style={{
            background: "radial-gradient(circle, white 0%, transparent 100%)",
